...
if [ -f models/output/$1/best.th ]
then
    if [ ! -f data/corpus/eval/annotated/annotated.en.$2.$1.hyp.txt ] && [ -f data/corpus/eval/annotated/gold/annotated.en.$2.src.txt ]
    then
        echo "Predicting annotated.en.$2.$1.hyp.txt"
    ...
    if [ ! -f data/corpus/eval/lang8/lang8.en.$2.$1.hyp.txt ] && [ -f data/corpus/eval/lang8/gold/lang8.en.$2.src.txt ]
    then
        echo "Predicting lang8.en.$2.$1.hyp.txt"
        eval python predict.py --model_path models/output/$1/best.th \
    ...
    if [ ! -f data/corpus/eval/bea19/bea19.dev.en.$1.hyp.txt ] && [ -f data/corpus/eval/bea19/gold/bea19.dev.en.src.txt ]
    then
        echo "Predicting bea19.dev.en.$2.$1.hyp.txt"
        eval python predict.py --model_path models/output/$1/best.th \
    ...
    then
        echo "Evaluating lang8.en.$2.$1.hyp.txt"
    ...
    then
        echo "Evaluating annotated.en.$2.$1.hyp.txt"
    ...
    then
        ...
        then
            echo "Evaluating bea19.dev.en.$2.$1.hyp.txt"
