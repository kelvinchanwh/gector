...
eval errant_compare -hyp data/corpus/eval/lang8/lang8.en.$2.$1.hyp.m2 -ref data/corpus/eval/lang8/lang8.en.$2.m2 -cat 3 >> results.$1.txt

echo "\"Lang-8 CS\"    Span    GED" >> results.$1.txt
eval errant_compare -hyp data/corpus/eval/lang8/lang8.en.$2.$1.hyp.m2 -ref data/corpus/eval/lang8/lang8.en.$2.m2 -cat 3 -ds >> results.$1.txt

echo "\"Annotated CS\"    Span    GEC" >> results.$1.txt
eval errant_compare -hyp data/corpus/eval/annotated/annotated.en.$2.$1.hyp.m2 -ref data/corpus/eval/annotated/annotated.en.$2.m2 -cat 3 >> results.$1.txt

echo "\"Annotated CS\"    Span    GED" >> results.$1.txt
eval errant_compare -hyp data/corpus/eval/annotated/annotated.en.$2.$1.hyp.m2 -ref data/corpus/eval/annotated/annotated.en.$2.m2 -cat 3 -ds >> results.$1.txt
