...
if [ -f data/corpus/eval/lang8/lang8.en.$2.$1.hyp.m2 ]
then
...
if [ -f data/corpus/eval/annotated/annotated.en.$2.$1.hyp.m2 ]
then
...
then
    eval errant_parallel -orig data/corpus/eval/bea19/bea19.dev.en.src.txt -cor data/corpus/eval/bea19/bea19.dev.en.$1.hyp.txt -out data/corpus/eval/bea19/bea19.dev.en.$1.hyp.m2
