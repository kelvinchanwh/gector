...
then
    ...
    echo "\"Lang-8 CS\"    $2    Span    GEC" >> results/results.$2.$1.txt
    eval errant_compare -hyp data/corpus/eval/lang8/lang8.en.$2.$1.hyp.m2 -ref data/corpus/eval/lang8/gold/lang8.en.$2.m2 -cat 3 >> results/results.$2.$1.txt

    echo "\"Lang-8 CS\"    $2    Span    GED" >> results/results.$2.$1.txt
    eval errant_compare -hyp data/corpus/eval/lang8/lang8.en.$2.$1.hyp.m2 -ref data/corpus/eval/lang8/gold/lang8.en.$2.m2 -cat 3 -ds >> results/results.$2.$1.txt
fi
...
then
    ...
    echo "\"Annotated CS\"    $2    Span    GEC" >> results/results.$2.$1.txt
    eval errant_compare -hyp data/corpus/eval/annotated/annotated.en.$2.$1.hyp.m2 -ref data/corpus/eval/annotated/gold/annotated.en.$2.m2 -cat 3 >> results/results.$2.$1.txt

    echo "\"Annotated CS\"    $2    Span    GED" >> results/results.$2.$1.txt
    eval errant_compare -hyp data/corpus/eval/annotated/annotated.en.$2.$1.hyp.m2 -ref data/corpus/eval/annotated/gold/annotated.en.$2.m2 -cat 3 -ds >> results/results.$2.$1.txt
fi
...
then
    ...
    echo "\"BEA-19 Dev\"    EN    Span    GEC" >> results/results.$2.$1.txt
    eval errant_compare -hyp data/corpus/eval/bea19/bea19.dev.en.$1.hyp.m2 -ref data/corpus/eval/bea19/gold/bea19.dev.en.m2 -cat 3 >> results/results.$2.$1.txt

    echo "\"BEA-19 Dev\"    EN    Span    GED" >> results/results.$2.$1.txt
    eval errant_compare -hyp data/corpus/eval/bea19/bea19.dev.en.$1.hyp.m2 -ref data/corpus/eval/bea19/gold/bea19.dev.en.m2 -cat 3 -ds >> results/results.$2.$1.txt
fi