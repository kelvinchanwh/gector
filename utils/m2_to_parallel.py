...
if len(sys.argv) != 4:
    ...
    # Eg. python utils/m2_to_parallel.py data/corpus/wi+locness/m2/ABCN.dev.gold.bea19.m2 data/corpus/parallel/locness.dev.src.txt data/corpus/parallel/locness.dev.tgt.txt
	sys.exit()
